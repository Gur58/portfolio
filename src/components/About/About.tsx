    ...
    return (
        <section id="about" className="flex flex-col">
            <div className="flex items-center flex-col lg:flex-row lg:justify-between">
                ...
                <img src={value === "light" ? artLight : artDark} alt="art" className="transition-opacity rounded-full bg-neutral-200 dark:bg-slate-900 w-96 border-solid border-8 border-[#15ccd5]"/>
            </div>
        </section>
    )
}
